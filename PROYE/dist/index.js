...
var author$project$Main$agregar = F3(
	function (_n0, _n1, _n2) {
		...
		return _List_fromArray(
			[
				_Utils_Tuple2((1 / 2) * (x1 + x2), (1 / 2) * (y1 + y2)),
				_Utils_Tuple2((1 / 2) * (x2 + x3), (1 / 2) * (y2 + y3)),
				_Utils_Tuple2((1 / 2) * (x1 + x3), (1 / 2) * (y1 + y3)),
				_Utils_Tuple2((1 / 2) * (x1 + x2), (1 / 2) * (y1 + y2))
			]);
	});
var author$project$Main$sierpinski = function (reps) {
	var _n0 = author$project$Main$fractal;
	if ((_n0.b && _n0.b.b) && _n0.b.b.b) {
		...
		var bs = _n2.b;
		return _Utils_ap(
			A3(author$project$Main$agregar, b1, b2, b3),
			bs);
	} else {
		return author$project$Main$fractal;
	}
...
var author$project$Main$view = function () {
	...
	var poligono = function (ctx) {
		return A2(
			...
			author$project$Main$koch(5),
			ctx);
	};
	var height = 1000;
	var frakt = function (ctx) {
		return A2(
			author$project$Main$dibujar,
			author$project$Main$sierpinski(9),
			ctx);
	};
	return A4(
